...
import { addSelectedLanguage, inspectMissingTranslations } from "../controllers/languagesController.js";
import { generateAllThemeTranslations, downloadTranslationsZip } from "../controllers/generateLanguage.js";
...
router.get("/inspect-missing-translations", inspectMissingTranslations);
router.get("/generate-selected-language", generateAllThemeTranslations);
router.get("/download-translations", downloadTranslationsZip);
