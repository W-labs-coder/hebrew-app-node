...
const Subscription = ({ subscriptions }) => {
  ...
  return (
    <div className="">
      ...
      >
        <div className="d-lg-flex flex-nowrap ais my-3 jcc px-2" style={{ gap: "15px" }}>
              ...
              >
                ...
                >
                  ...
                  <div className="d-flex jcb aie">
                    <p className="fw600 fs28">${subscription.amount}</p>
                    <p className="fs12" style={{ color: "#777777" }}>
                      חיוב מדי{" "}
                  ...
                  <p className="fw600 fs14">{subscription.name} Plan</p>
